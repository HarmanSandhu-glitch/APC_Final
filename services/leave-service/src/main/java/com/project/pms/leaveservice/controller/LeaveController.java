...
public class LeaveController {
  ...
  public ResponseEntity<Leave> applyForLeave(@PathVariable Long employeeId,
  ...
  updateLeaveStatus(@PathVariable Long leaveId,
  ...
  getLeavesForEmployee(@PathVariable Long employeeId) {
